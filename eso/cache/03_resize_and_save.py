...
from exo.models import ContentKey, ContentInstance, ContentContainer
from exo.models import ContentSignature, Tag2
from django.db.models import Count

instance=ContentInstance.objects.filter(content_container__id=2)
    .filter(filename__endswith='.jpg').first()
filename="/".join([
        instance.content_container.path,
        instance.relpath,
        instance.filename,
    ])
